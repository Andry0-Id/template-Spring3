...
* The original package name 'com.template-Spring3.template' is invalid and this project uses 'com.templateSpring3.template' instead.
...
* [OAuth2 Resource Server](https://docs.spring.io/spring-boot/docs/3.0.9/reference/htmlsinge/index.html#web.security.oauth2.server)
